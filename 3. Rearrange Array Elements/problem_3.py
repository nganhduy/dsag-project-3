...
if __name__ == '__main__':
    ...
    # Test Case 1 proper merge behavior
    assert reverse_merge([1], [2]) == [2, 1]
    assert reverse_merge([3, 1], [4, 2]) == [4, 3, 2, 1]

    # Test Case 2 proper sort behavior
    assert merge_sort(test_list) == [5, 4, 3, 2, 1]

    # Test Case 3 Should print 531, 42
    print(rearrange_digits([1, 2, 3, 4, 5]))

    # Test Case 4 Should print 964, 852
    print(rearrange_digits([4, 6, 2, 5, 9, 8]))

    # Test Case 5 Should print 1000, 100
    print(rearrange_digits([0, 0, 1, 1, 0, 0, 0]))

    # Test Case 6 Should return 0, 0
    print(rearrange_digits([0, 0, 0, 0, 0, 0, 0]))

    # Test Case 7 Single digit, should print 5, None
    print(rearrange_digits([5]))

    # Test Case 8 Empty list, should raise an error
